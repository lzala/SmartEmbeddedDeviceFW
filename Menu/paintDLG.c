...
static void _cbPaintDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    vFrame = WM_CreateWindowAsChild(r.x0 +20, r.y0 + 22, r.x1 , r.y1 - 25, hClient, WM_CF_SHOW, _cbDrawWindow , 0);
  ...
  case WM_NOTIFY_PARENT:
    ...
    NCode = pMsg->Data.v;
    switch(Id) {
    case ID_BUTTON_SET_BLUE: // Notifications sent by ''
      switch(NCode) {
      ...
      case WM_NOTIFICATION_RELEASED:
    	  currentColor = BUTTON_GetBkColor(WM_GetDialogItem(pMsg->hWin, Id),BUTTON_CI_PRESSED);
    	  WM_InvalidateRect(drawWin, &drawAreaRect); /*request repaint (WM_PAINT) for drawWin*/
        break;
      // USER START (Optionally insert additional code for further notification handling)
      // USER END
      }
      break;
    case ID_BUTTON_SET_GREEN: // Notifications sent by ''
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
        // USER END
      ...
      break;
    case ID_BUTTON_SET_RED: // Notifications sent by ''
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
        // USER END
      ...
      break;
    case ID_BUTTON_SET_MAGENTA: // Notifications sent by ''
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
        // USER END
      ...
      break;
    case ID_BUTTON_SET_YELLOW: // Notifications sent by ''
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
        // USER END
      ...
      break;
    case ID_BUTTON_SET_BLACK: // Notifications sent by ''
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
        // USER END
