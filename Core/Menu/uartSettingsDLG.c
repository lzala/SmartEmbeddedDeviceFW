...
/*local functions*/
uint8_t uartPutChar (USART_TypeDef* USARTx, xQueueHandle UARTx_TXq, uint8_t data);
uint8_t uartGetChar (USART_TypeDef* USARTx, xQueueHandle UARTx_TXq);
uint8_t USART_SendString(USART_TypeDef* USARTx, xQueueHandle UARTx_TXq, uint8_t length, const uint8_t* Data);
uint8_t USART_ReceiveString(USART_TypeDef* USARTx, xQueueHandle UARTx_RXq, uint8_t length, char* bufferRx);
...
/**
  ...
  */
uint8_t uartGetChar (USART_TypeDef* USARTx, xQueueHandle UARTx_RXq){
	uint8_t buf;
